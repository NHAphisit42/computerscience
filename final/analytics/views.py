...
def getCluster(GPA, plan, weitr_program):
    ...
    if predictions_cluster == 0:
        return "เน้นการปูพื้นฐานด้านเขียนโปรแกรม โดยเริ่มสอนตั้งแต่พื้นฐาน และ สอนด้านภาษา ทบทวนทักษะด้านคำนวณ"
    elif predictions_cluster == 1:
        return "เน้นการทบทวนพื้นฐานด้านเขียนโปรแกรมปูพื้นฐานทักษะด้านคำนวณ และ สอนด้านภาษา"
    else:
        return "เน้นการปูพื้นฐานด้านเขียนโปรแกรมโดยเริ่มสอนตั้งแต่พื้นฐาน และ สอนทักษะด้านคำนวณทบทวนด้านภาษา"